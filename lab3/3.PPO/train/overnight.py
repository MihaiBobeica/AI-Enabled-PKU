"""One-command overnight for hybrid PPO: Optuna then full train (wall-clock capped).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="PPO: Optuna then timed full train")
    ...
    train_cmd = [sys.executable, str(ROOT / "run.py"), "train"]
